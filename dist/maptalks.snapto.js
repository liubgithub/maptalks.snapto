...
var SnapTool = function (_maptalks$Class) {
    ...
    SnapTool.prototype.enable = function enable(callback) {
        var map = this.getMap();
    ...
    SnapTool.prototype._registerEvents = function _registerEvents(map, callback) {
    ...
    SnapTool.prototype._toGeoJSON = function _toGeoJSON(geometries) {
        var _snapGeometries = [];
...
typeof console !== 'undefined' && console.log('maptalks.snapto v0.2.0, requires maptalks@^0.16.0.');
